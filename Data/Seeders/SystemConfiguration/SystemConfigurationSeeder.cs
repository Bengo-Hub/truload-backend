    ...
    private async Task SeedApplicationSettingsAsync()
    {
        var settings = new[]
        {
            ...
            new ApplicationSettings
            {
                ...
                Description = "Number of days to retain backup files before automatic deletion (aging policy)",
                DefaultValue = "30",
                IsEditable = true,
                SortOrder = 3,
                CreatedAt = DateTime.UtcNow,
            ...
            {
                Id = Guid.NewGuid(),
                SettingKey = SettingKeys.BackupPgDumpPath,
                SettingValue = "pg_dump",
                SettingType = "String",
                Category = SettingKeys.CategoryBackup,
                DisplayName = "pg_dump Executable Path",
                Description = "Path to the pg_dump executable used for creating database backups",
