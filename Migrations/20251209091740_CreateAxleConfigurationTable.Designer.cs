...
namespace truload_backend.Migrations
{
    ...
    [Migration("20251209091740_CreateAxleConfigurationTable")]
    partial class CreateAxleConfigurationTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TruLoad.Backend.Features.AxleConfiguration.Models.AxleConfiguration", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<string>("AxleLimits")
                        .HasColumnType("jsonb")
                        .HasColumnName("axle_limits");

                    b.Property<string>("AxlePattern")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                        .HasColumnName("axle_pattern");
                    ...
                    b.Property<int>("TotalAxles")
                        .HasColumnType("integer")
                        .HasColumnName("total_axles");
                    ...
                    b.HasIndex("Code")
                        .IsUnique()
                        .HasDatabaseName("idx_axle_configs_code_unique");

                    b.HasIndex("IsActive")
                        .HasDatabaseName("idx_axle_configs_is_active");

                    b.HasIndex("TotalAxles")
                        .HasDatabaseName("idx_axle_configs_total_axles");
